...
<body class="hm">
	...
	<div>
		...
		<span class="pl-sm-5"><b>Payment</b>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="Payment" placeholder="PAYMENT" value="<%=DataUtility.getStringData(dto.getPayment())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("Payment", request)%></font></br>			
	
	<span class="pl-sm-5"><b>Reciept</b>
	<span style="color: red;">*</span></span></br> 
    <div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" name="Reciept" placeholder="Reciept" value="<%=DataUtility.getStringData(dto.getReciept())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("Reciept", request)%></font></br>		
							<div class="text-center">
 									
									<input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=OrderCtl.OP_SAVE%>">
							</div>
