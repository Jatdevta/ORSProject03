...
<body class="hm">
 ...
 --%>
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="Reciept" placeholder="Reciept"
						class="form-control"
						value="<%=ServletUtility.getParameter("Reciept", request)%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getPayment()%></td>
							<td class="text"><%=dto.getReciept()%></td>
