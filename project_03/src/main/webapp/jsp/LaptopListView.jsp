...
<%@page import="in.co.rays.project_3.dto.LaptopDTO"%>
...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.LaptopDTO"
 ...
 --%>
			...
			<%
				...
				Iterator<LaptopDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="OrderStatus" placeholder="OrderStatus"
						class="form-control"
						value="<%=ServletUtility.getParameter("OrderStatus", request)%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">OrderStatus</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getOrderStatus()%></td>

							<td class="text"><a href="OrderCtl?id=<%=dto.getId()%>">Edit</a>
							</td>
						</tr>
					</tbody>
					<%
