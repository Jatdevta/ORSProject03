...
<body class="hm">
	...
	<div>
		...
		<span class="pl-sm-5"><b>AccountNo</b>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="accountNo" placeholder="Account NO" value="<%=DataUtility.getStringData(dto.getAccountNo())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("accountNo", request)%></font></br>			
	
	<span class="pl-sm-5"><b>AccountType</b>
	<span style="color: red;">*</span></span></br> 
    <div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" name="Name" placeholder="Name" value="<%=DataUtility.getStringData(dto.getName())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("Name", request)%></font></br>		
							<div class="text-center">
									...
									style="font-size: 17px" value="<%=BankCtl.OP_SAVE%>">
							</div>
