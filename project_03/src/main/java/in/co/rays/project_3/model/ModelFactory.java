...
public final class ModelFactory {
	...
	public LaptopModelInt getLaptopModel() {
		LaptopModelInt laptopModel = (LaptopModelInt) modelCache.get("laptopModel");
		if (laptopModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				laptopModel = new LaptopModelHibImp();
			}

			modelCache.put("laptopModel", laptopModel);
		}
		return laptopModel;
	}
}
