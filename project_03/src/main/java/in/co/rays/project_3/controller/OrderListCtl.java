...
public class OrderListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("LaptopListCtl doGet Start");
		List list;
		List next;
		int pageNo = 1;
...
// get the selected checkbox ids array for delete list
		...
		try {
			...
			ArrayList<LaptopDTO> a = (ArrayList<LaptopDTO>) list;

			for (LaptopDTO udto1 : a) {
...
// TODO Auto-generated catch block
		...
		log.debug("LaptopListCtl doPOst End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		log.debug("LaptopListCtl doPost Start");
		List list = null;
		List next = null;
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					LaptopDTO deletedto = new LaptopDTO();
					for (String id : ids) {
			...
			dto = (LaptopDTO) populateDTO(request);
...
// TODO Auto-generated catch block
		...
		log.debug("LaptopListCtl doGet End");
	}
