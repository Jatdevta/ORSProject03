...
public interface ORSView {
	...
	public String ORDER_VIEW = PAGE_FOLDER + "/LaptopView.jsp";
	public String ORDER_LIST_VIEW = PAGE_FOLDER + "/LaptopListView.jsp";
	//public String LAPTOP_VIEW = PAGE_FOLDER + "/LaptopView.jsp";
	//public String LAPTOP_LIST_VIEW = PAGE_FOLDER + "/LaptopListView.jsp";
	...
	//public String LAPTOP_CTL = APP_CONTEXT + "/ctl/LaptopCtl";
	//public String LAPTOP_LIST_CTL = APP_CONTEXT + "/ctl/LaptopListCtl";
